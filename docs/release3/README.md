...
- **Work routines**
  ...
  During development, we utilised agile development for iteratively progressing our program. We created clear and concise [user stories](../../userstories.md) to establish the needs of the end users, and planned sprints (release 1, 2, and 3) to integrate the desired functionality.
